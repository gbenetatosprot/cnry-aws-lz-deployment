...
variable "staging_subnets" {
  description = "A list of staging subnets inside the VPC"
  type        = list(string)
  default     = []
}

variable "staging_subnet_enable_resource_name_dns_a_record_on_launch" {
  description = "Indicates whether to respond to DNS queries for instance hostnames with DNS A records. Default: `false`"
  type        = bool
  default     = false
}
...
variable "staging_subnet_names" {
  description = "Explicit values to use in the Name tag on database subnets. If empty, Name tags are generated"
  type        = list(string)
  default     = []
}

variable "staging_subnet_suffix" {
  description = "Suffix to append to database subnets name"
  type        = string
  default     = "staging"
}

variable "create_staging_subnet_route_table" {
...
variable "create_staging_nat_gateway_route" {
  description = "Controls if a nat gateway route should be created to give internet access to the database subnets"
  type        = bool
  default     = false
}

variable "staging_route_table_tags" {
  description = "Additional tags for the database route tables"
  type        = map(string)
  default     = {}
}

variable "staging_subnet_tags" {
  description = "Additional tags for the database subnets"
  type        = map(string)
  default     = {}
}

variable "staging_subnet_group_tags" {
...
variable "staging_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for database subnets"
  type        = bool
  default     = false
}

variable "staging_inbound_acl_rules" {
...
variable "staging_outbound_acl_rules" {
